...
class F1StrategyAgent:
    ...
    def _make_decision(
        self, lap: int, tire_age: int, tire_compound: str, weather: dict, scenario: dict
    ) -> tuple:
        """
        ...
        if "gaps" in scenario and lap > 40 and lap < 58:
            ...
            gap_ahead = gaps.get("to_p1") or gaps.get("to_p2") or gaps.get("to_p3") or 0
            gap_behind = gaps.get("to_p4") or gaps.get("to_p5") or gaps.get("to_p6") or 0
