...
GOLDEN_DATASET_SCHEMA = {
    "required_fields": {
        ...
        "scenario": [
            "id", "name", "lap", "driver", "position",
            "tires", "weather", "context", "golden_truth", "test_criteria"
        ],
        "golden_truth": [
            "decision", "rationale", "confidence_level", "risk_level"
        ],
    ...
    "valid_values": {
        ...
        "weather_condition": [
            "dry", "wet", "damp", "drizzle", "rain",
            "heavy_rain", "mixed", "changing"
        ]
    }
}
